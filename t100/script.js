...
var characterNotes = [];
characterNotes["Polêmicas"] = "Controvérsias envolvendo Michel Temer, integrantes do governo ou políticas federais.";
characterNotes["Políticas"] = "Questões envolvendo políticas públicas a respeito de diversos temas, como econômicos, sociais, ambientais etc. promovidos pelo governo federal e seus membros.";
characterNotes["Repercussões"] = "Reflexões, comentários gerais, opiniões, manifestações a respeito do governo interino ou sobre o presidente interino por interlocutores de fora do Executivo, seja a neutro, indefinido, a favor ou contra ele.";
characterNotes["Nomeações"] = "Indicações ou exonerações feitas por Michel Temer para cargos federais e articulações para posições no Congresso.";
characterNotes["Declarações"] = "Reflexões, comentários gerais, opiniões de dentro do governo interino sobre a situação atual do país, previsões, promessas, posicionamentos, itens de itinerário.";
...
d3.json('dados.json', function (error, dataAgg) {
	...
	//Cores
	var locations = ["Congresso & Base Aliada",	"Cortes & Revisões", "Impeachment",	"Ministros & Cargos", "Novas Políticas", "Outros", "Políticas Existentes",	"Protestos", "Temer"];
	var colors = ['#8e0152','#c51b7d','#de77ae','#f1b6da','#cab4bf','#a1ab91','#b8e186','#7fbc41','#4d9221','#276419'];
