...
function  setPreNext(targetDiv, currentPage, currentPage, totalPages, data, pagination) {
  ...
  $(targetDiv).append("<div id='Pagination' pageno='" + currentPage + "'" + "class='table-pagination'>Mostrando página "
    + currentPage + " de " + totalPages + " <a class='pagination-pre-" + tableId + "'>Previous</a>" +
...
function  writePreNext(targetDiv, currentPage, currentPage, totalPages, data, pagination) {
  var tableId = targetDiv.slice(1)
  $(targetDiv).append("<div id='Pagination' pageno='" + currentPage + "'" + "class='table-pagination'><br><br>Mostrando página "
    + currentPage + " de " + totalPages + " <a class='pagination-pre-" + tableId + "'>Previous</a>" +
    " <a class='pagination-next-" + tableId + "'>Next</a></p></div>" )
